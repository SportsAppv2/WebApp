        ...
        <div className='w-screen h-screen fixed top-0 left-0 bg-gray-20 flex justify-center items-center'>
            <div className='bg-[black] h-fit max-h-[600px] overflow-y-scroll w-[400px] text-white-100 p-5 rounded-2xl'>
                <div className='flex items-center mx-5 text-[22px]'>
                    <div onClick={() => {dispatch(tournamentActions.showAddParticipant())}}>
                ...
                <div className='p-5'>
                    <div className='mb-5'>
                        ...
                        onChange={(e) => {dispatch(tournamentActions.addParticipantName(e.target.value))}}/>
                    </div>
                    <div className='mb-5'>
                        <div className='text-gray-600'>
                            Country
                        ...
                        value={data.teamData.country} onChange={(e) => {dispatch(tournamentActions.addParticipantCountry(e))}}/>
                    </div>
                    <div className='mb-5'>
                        <div className='text-gray-600'>
                            Email
                        ...
                        <input type="text" 
                        className='bg-[black] border-gray-600 border-[1px] w-full text-white-100 p-2 outline-none shadow-md'
                        onChange={(e) => {dispatch(tournamentActions.addParticipantEmail(e.target.value))}}/>
                    </div>
                    <div ref={logo}>
                        ...
                        accept='image/*'
                        className='hidden'
                        onChange={(e) => {dispatch(tournamentActions.participantLogoAdded(showLogo(e)))}}/>
                    </div>
                    <div
                    className="files hidden flex w-fit text-white-30 bg-[#151516] rounded-lg mb-5 p-1"
                    ref={filetag}
                    >
                        <div>{data.participantData.logo}</div>
                        <button
                        className="ml-3"
                        onClick={() => {
                            dispatch(tournamentActions.participantlogoDeleted());
                        }}
                        >
