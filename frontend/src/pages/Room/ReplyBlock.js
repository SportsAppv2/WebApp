    ...
    return (
        <div className='bg-[#000000] border-gray-600 border-2 text-gray-600 rounded-3xl p-3'>
            <div className='flex ml-11 text-[16px] font-medium italic'>
                ...
                <div className='text-[#5D5FEF] ml-2'>
                    @FabrizioRomano
                </div>
            </div>
            <div className='flex mt-2 ml-2'>
                <div className='h-[50px] w-[50px] rounded-full mr-3'>
                    <img src="https://www.whoa.in/download/cristiano-ronaldo-back-view-wallpaper" alt="" 
                ...
                ref={ta}
                value={data.text}
                onChange={(e) => {dispatch(replyActions.contentChanged(e.target.value))}}
                ...
                placeholder='Comment as @hawk123'></textarea>
            </div>
            <div
