  ...
  return (
    <div className="h-screen w-screen fixed top-0 left-0">
      ...
      <div className="h-fit w-[580px] bg-[#000000] text-white-100  m-auto mt-[80px] rounded-3xl relative p-5">
        ...
        <div
          className="absolute top-[20px] right-[20px] text-[22px] text-[#5D5FEF] hover:text-blue-60 cursor-pointer"
          onClick={() => {
            toggle();
          }}
        >
        ...
        <div className="overflow-y-scroll mt-5">
          <div className="mt-5 mx-5 max-h-[50vh]">
            <div className="flex justify-between my-2">
              <div className="w-[45%]">
                <div className="text-gray-600">First Name</div>
                <input
                  type="text"
                  value={data.editedData.firstName}
              ...
              <div className="w-[45%]">
                ...
                <input
                  type="text"
                  value={data.editedData.lastName}
                  className="bg-[#000000] border-gray-600 border-[1px] p-2 w-full"
                  onChange={(e) => {
            ...
            <div className="my-2">
              <div className="text-gray-600">Media Handles</div>
              <div className="flex items-center my-2">
                <BsInstagram className="text-[24px] mr-5" />
                <input
                  type="text"
                  value={data.editedData.instagram}
              ...
              <div className="flex items-center my-2">
                ...
                <input
                  type="text"
                  value={data.editedData.facebook}
        ...
        <div className="flex justify-center my-5">
          <button
            className="bg-white-100 font-semibold text-[18px] text-[#000000] rounded-2xl p-3 px-5 hover:bg-gray-400"
            onClick={() => {
